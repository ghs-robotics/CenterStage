...
public final class Kinematics {
    ...
    @NotNull
    public Twist2dDual forward(@NotNull WheelIncrements w) {
        Intrinsics.checkNotNullParameter(w, "w");
        return new Twist2dDual(new Vector2dDual(w.left.plus(w.right).times(0.5 / this.lateralMultiplier), w.back), w.left.plus(w.right).div((double)2 * this.trackWidth));
    }

    @NotNull
    public WheelVelocities inverse(@NotNull PoseVelocity2dDual t) {
        Intrinsics.checkNotNullParameter(t, "t");
        return new WheelVelocities(t.linearVel.x.minus(t.angVel.times(0.5).times(this.trackWidth)),
...
//    )
    public static final class WheelIncrements {
        @NotNull
        public final DualNum left;
        @NotNull
        public final DualNum right;
        @NotNull
        public final DualNum back;

        public WheelIncrements(DualNum left, DualNum right, DualNum back) {
            super();
        ...
        @NotNull
        public final DualNum component1() {
            return this.left;
        }

        @NotNull
        public final DualNum component2() {
            return this.right;
        }

        @NotNull
        public final DualNum component3() {
            return this.back;
        }

        @NotNull
        public final WheelIncrements copy(DualNum left, DualNum right, DualNum back) {
            Intrinsics.checkNotNullParameter(left, "left");
            Intrinsics.checkNotNullParameter(right, "right");
            Intrinsics.checkNotNullParameter(back, "back");
...
//    )
    public static final class WheelVelocities {
        ...
        @NotNull
        public DualNum[] all() {
            return new DualNum[]{this.left, this.right, this.back};
        }

        public WheelVelocities(DualNum left, DualNum right, DualNum back) {
            super();
            Intrinsics.checkNotNullParameter(left, "left");
            Intrinsics.checkNotNullParameter(right, "right");
            Intrinsics.checkNotNullParameter(back, "back");
        ...
        @NotNull
        public DualNum component1() {
            return this.left;
        }

        @NotNull
        public DualNum component2() {
            return this.right;
        }

        @NotNull
        public DualNum component3() {
            return this.back;
        }
...
//    )
    public final class WheelVelConstraint implements VelConstraint {
        ...
        public double maxRobotVel(@NotNull Pose2dDual robotPose, @NotNull PosePath path, double s) {
            ...
            Iterable var8 = (Iterable) Kinematics.this.inverse(PoseVelocity2dDual.Companion.constant(robotVelRobot, 1)).all();
            Iterator var9 = var8.iterator();
            if (!var9.hasNext()) {
                throw new NoSuchElementException();
            } else {
                DualNum itx = (DualNum)var9.next();
                boolean var11 = false;
                double var12 = this.maxWheelVel / itx.value();

                double var14;
                for(var14 = Math.abs(var12); var9.hasNext(); var14 = Math.min(var14, var12)) {
                    DualNum it = (DualNum)var9.next();
                    boolean var17 = false;
