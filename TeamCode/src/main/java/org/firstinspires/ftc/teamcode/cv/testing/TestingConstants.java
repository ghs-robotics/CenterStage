...
//    public static int H_STRICT_UPPER_RED = 109;
//    public static int H_STRICT_LOWER_RED = 90;
//    public static int S_STRICT_UPPER_RED = 200;
//    public static int S_STRICT_LOWER_RED = 0;
//    public static int V_STRICT_UPPER_RED = 255;
//    public static int V_STRICT_LOWER_RED = 100;
//
//    public static int H_FIRST_UPPER_RED = 114;
//    public static int H_FIRST_LOWER_RED = 99;
//    public static int S_FIRST_UPPER_RED = 230;
//    public static int S_FIRST_LOWER_RED = 90;
//    public static int V_FIRST_UPPER_RED = 235;
//    public static int V_FIRST_LOWER_RED = 60;
//}
